...
/**
 * Programa para receber 3 valores e exibir em order decrescente
 * 
 * @author Diego Silva
 * @since 09/02/2021
 */
public class Exercicio53 {
	...
	public static void main(String[] args) {
		...
		num1 = Double.parseDouble(
				JOptionPane.showInputDialog("Vamos  ordenar números em ordem decrescente, para isso, informe abiaxo: "
		...
		JOptionPane.showMessageDialog(null,
				"Números em order crescente " + terceiro + " - " + segundo + " - " + primeiro);
	}
